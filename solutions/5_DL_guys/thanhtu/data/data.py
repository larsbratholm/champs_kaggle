...
from build.data.graph import StructureGraph, GaussianDistance
from build.data.utils import (expand_1st, fast_label_binarize, to_list, ring_to_vector,
                   write_file_to_pickle, read_pickle_from_file)
from build.data.utils import Struct
...
def mol_from_file(molecule_name,
    ...
    """
    file_path = f'{path_data}/structures/{molecule_name}.xyz'
...
#     graph_dir = '/home/ubuntu/datalab/kaggle/champ_scalar/data/structure/graph2'
...
if __name__ == "__main__":
    ...
    run_convert_to_graph(opt.data_dir, opt.split_dir, opt.graph_dir)
