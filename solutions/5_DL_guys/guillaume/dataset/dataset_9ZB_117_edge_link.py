...
permute_results = pd.read_pickle('processed_data/permute_results.9Y.pkl')
features = permute_results.loc[permute_results['loss'] > -2.09]
features = features.loc[~features['feature_name'].str.contains('dist_H')]

names = pd.read_pickle('processed_data/names_117.pkl')
...
class EdgeBasedDataset(Dataset):
    def __init__(self, name = 'train'):
        ...
        self.global_features = h5py.File('processed_data/global_116.h5', mode = 'r')
        self.atom_features = h5py.File('processed_data/atom_116.h5', mode = 'r')
        self.bond_features = h5py.File('processed_data/bond_116.h5', mode = 'r')
        ...
        self.atom_descriptors = pd.read_pickle('processed_data/atom_descriptors_117.pkl')
        self.bond_descriptors = pd.read_pickle('processed_data/bond_descriptors_117.pkl')
        
        self.dataset = pd.read_pickle('processed_data/dataset_descriptor_117.pkl')
        
        self.cycles = pd.read_pickle('processed_data/cycles_117.pkl').set_index('molecule_id')
        self.edges_connectivity = pd.read_hdf('processed_data/edges_connectivity_117.pkl', 'data').set_index('molecule_id')
